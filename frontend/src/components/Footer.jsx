...
const Footer = () => {
  return (
    <div>
        <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] ] gap-14 my-10 mt-40 max-sm:mt-10 text-sm max-sm:gap-5'>

            <div>
                <img src='main-logo.png' alt='logo' className='mb-3 w-25 max-sm:w-15' />
